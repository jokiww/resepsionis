        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-md-10 pr-md-0">
                    <nav class="navbar navbar-expand-md btco-hover-menu py-lg-2" id="demo1Navbar">>
                        ...
                        <div class="collapse navbar-collapse" id="fablesNavDropdown">
                            ...
                            <ul class="navbar-nav mx-auto fables-nav">
                                ...
                                <li class="nav-item ">
                                    <a class="nav-link " href="about.php" id="" data-toggle="" aria-haspopup="" aria-expanded="">
                                        Profil
                                    </a>
                                ...
                                <li class="nav-item ">
                                    <a class="nav-link " href="produk.php" id="" data-toggle="" aria-haspopup="" aria-expanded="">
                                        Store
                                    </a>
                                </li>
                                <li class="nav-item ">
                                    <a class="nav-link " href="blog-cat.php" id="" data-toggle="" aria-haspopup="" aria-expanded="">
                                        Blog
                                    </a>
                    ...
                    <div class="owl-carousel owl-theme default-carousel nav-0 z-index mt-md-4 mt-xl-5 pt-md-4 pt-xl-5 dots-0 pb-md-5">
                        <div class="pt-0 mt-0 pt-xl-5 mt-xl-5 wow slideInUp" data-wow-duration="2s" data-wow-delay=".4s">
                            ...
                            <p class="fables-forth-text-colo mb-3 light-font fables-header-slider-details">
                                consultation with every problem and solved together, to achieve the best results with results that satisfy the client and with the confidentiality of each party
                            </p>
                            <a href="about.php" class="btn fables-second-background-color fables-second-border-color white-color rounded-0 mr-4 px-3 px-md-4 py-2 bg-hover-transparent fables-second-hover-color">Our Services</a>
                            <a href="#start" class="btn fables-second-border-color fables-second-text-color rounded-0 px-3 px-md-4 py-2 fables-second-hover-background-color">Learn More</a>
                        </div>
    ...
    <div class="container" id="start">
        <div class="row my-3 my-md-5 overflow-hidden">
            ...
            <div class="col-12 col-sm-6 col-lg-3 text-center mb-4 mb-lg-0 wow fadeInDown" data-wow-delay=".8s" data-wow-duration="1.5s">
                ...
                <h2 class="fables-main-text-color font-18 my-2">TEAM WORK</h2>
                <p class="fables-forth-text-color font-15">
                    embracing each other in business obligations
                </p>
            </div>
            <div class="col-12 col-sm-6 col-lg-3 text-center mb-4 mb-lg-0 wow fadeInDown" data-wow-delay="1.2s" data-wow-duration="1.5s">
                ...
                <h2 class="fables-main-text-color font-18 my-2">SAFE PRICE</h2>
                <p class="fables-forth-text-color font-15">
                    people's prices, conglomerate quality
                </p>
            </div>
            <div class="col-12 col-sm-6 col-lg-3 text-center mb-4 mb-lg-0 wow fadeInDown" data-wow-delay="1.6s" data-wow-duration="1.5s">
                ...
                <h2 class="fables-main-text-color font-18 my-2">PROFIT INCREASE</h2>
                <p class="fables-forth-text-color font-15">
                    Consultation to reach the point of success
                </p>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-12 col-md-10 offset-md-1 col-lg-8 offset-lg-2 text-center">
                ...
                <p class="fables-forth-text-color">
                    Agencies that prioritize facts, client results, and cooperation, rather than just marketing-driven promotions
                </p>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-12 col-md-10 offset-md-1 col-lg-8 offset-lg-2">
                <div class="text-center">
                    ...
                    <p class="fables-forth-text-color">
                        We assist clients from a variety of disciplines who consult with us about their project work and generate an actual result, and we are granted permission to post project outcomes on our website.
                    </p>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-12 col-md-8">
                    <div class="fables-contact-caption-txt">
                        ...
                        <p class="fables-third-text-color position-relative z-index font-weight-light">You may fill out the form we've provided to request further information, and we'll get it and process it all when we receive it.</p>
