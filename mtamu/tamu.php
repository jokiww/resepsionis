...
if (!$result) {
    ...
    <main class="cd__main">
        ...
        <div class="text-center">
            <a href="tcetak.php" style="position: absolute;left: 84vh;">
                <button class="btn btn-warning"><i class="fa-solid fa-user-plus"></i>Print Data</button>
            </a>
        </div>
        <div class="text-center">
            <a href="mttambah.php" style="position: absolute;">
                ...
                <tbody>
                    ...
                    ?>
                        ...
                        <tr class="table-light">
                            ...
                            <td class="col-2">
                                <a href="mtubah.php?no_kunjungan=<?= $row["no_kunjungan"]; ?>" onclick="return confirm ('YAKIN MERUBAH DATA ?')"><i class="fa-solid fa-user-pen"></i></a> |
                                <a href="mthapus.php?no_kunjungan=<?= $row["no_kunjungan"]; ?>" onclick="return confirm ('YAKIN MENGHAPUS DATA ?')"><i class="fa-solid fa-trash"></i></a>
                            </td>
                        </tr>
