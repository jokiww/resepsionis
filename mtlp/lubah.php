...
<head>
    ...
    <title>Ubah Data Panggilan</title>
    <!-- animate.css-->
...
<body>
    ...
    <div class="fables-header fables-after-overlay">
        <div class="container">
            <h2 class="fables-page-title fables-second-border-color">Ubah Data Panggilan</h2>
        </div>
    </div>
    <!-- /End Header -->
        ...
        <div class="container">
            <nav aria-label="breadcrumb">
                <ol class="fables-breadcrumb breadcrumb px-0 py-3">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Ubah Data Panggilan</li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <main class="cd__main">
        ...
        <form method="post">
            ...
            <div class="mb-3">
                <label for="id_tlp" class="form-label">ID.Tlp</label>
                <input type="text" class="form-control" name="id_tlp" id="id_tlp" required value="<?= $tlp["id_tlp"] ?>">
            </div>

            <div class="mb-3">
                <label for="atas_nama" class="form-label">Nama Pengunjung</label>
                <input type="text" class="form-control" name="atas_nama" id="atas_nama" required value="<?= $tlp["atas_nama"] ?>">
            </div>

            <div class="mb-3">
                <label for="jekel" class="form-label">Jenis Kelamin</label><br>
                <label><input type="radio" name="jekel" value="L" <?php if ($tlp['jekel'] == 'L') echo 'checked' ?>>Laki - Laki</label><br>
                <label><input type="radio" name="jekel" value="P" <?php if ($tlp['jekel'] == 'P') echo 'checked' ?>>Perempuan</label>
            </div>

            <div class="mb-3">
                <label for="pihak_instansi" class="form-label"><b>Pihak Instansi Pengirim :</b></label>
                <input type="text" class="form-control" name="pihak_instansi" id="pihak_instansi" required value="<?= $tlp["pihak_instansi"] ?>">
            </div>

            <div class="mb-3">
                <label for="alamat_instansi" class="form-label"><b>Alamat Instansi :</b></label>
                <input type="text" class="form-control" name="alamat_instansi" id="alamat_instansi" required value="<?= $tlp["alamat_instansi"] ?>">
            </div>

            <div class="mb-3">
                <label for="tgl" class="form-label"><b>Tanggal Penerimaan :</b></label>
                <input type="date" class="form-control" name="tgl" id="tgl" required  value="<?= $tlp["tgl"] ?>">
            </div>

            <div class="mb-3">
                <label for="no_tlp" class="form-label"><b>No.Telepon :</b></label>
                <input type="text" class="form-control" name="no_tlp" id="no_tlp" required  value="<?= $tlp["no_tlp"] ?>">
            </div>

            <div class="mb-3">
                <label for="jenis_kepentingan" class="form-label"><b>Jenis Kepentingan :</b></label><br>
                <label><input type="radio" name="jenis_kepentingan" value="urgent" <?php if ($tlp['jenis_kepentingan'] == 'urgent') echo 'checked' ?>>Urgent</label><br>
                <label><input type="radio" name="jenis_kepentingan" value="tidak urgent" <?php if ($tlp['jenis_kepentingan'] == 'tidak urgent') echo 'checked' ?>>TIdak Urgent</label>
            </div>

            <div class="mb-3">
                <label for="penujuan_tlp" class="form-label"><b>Tujuan Pemanggilan :</b></label>
                <input type="text" class="form-control" name="penujuan_tlp" id="penujuan_tlp" value="<?= $tlp["penujuan_tlp"] ?>">
            </div>

            <div class="mb-3">
                <label for="notes_tlp" class="form-label"><b>Notes Pemanggilan :</b></label>
                <input type="text" class="form-control" name="notes_tlp" id="notes_tlp" required value="<?= $tlp["notes_tlp"] ?>">
            </div>
