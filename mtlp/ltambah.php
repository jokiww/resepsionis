...
<head>
    ...
    <title>Tambah Data Panggilan</title>
    <!-- animate.css-->
...
<body>
    ...
    <div class="fables-header fables-after-overlay">
        <div class="container">
            <h2 class="fables-page-title fables-second-border-color">Tambah Data Panggilan</h2>
        </div>
    </div>
    <!-- /End Header -->
        ...
        <div class="container">
            <nav aria-label="breadcrumb">
                <ol class="fables-breadcrumb breadcrumb px-0 py-3">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Tambah Data Panggilan</li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <main class="cd__main">
        ...
        <form method="post">
            ...
            <div class="mb-3">
                <label for="id_tlp" class="form-label">No.Kunjungan</label>
                <input type="text" class="form-control" name="id_tlp" id="id_tlp" required>
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="penujuan_tlp" id="penujuan_tlp" >
            </div>

            <div class="mb-3">
                <label for="notes_tlp" class="form-label"><b>Notes Pemanggilan :</b></label>
                <input type="text" class="form-control" name="notes_tlp" id="notes_tlp" required >
            </div>
