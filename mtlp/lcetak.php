...
<div class="container">
    <br>
			<h2><center><b>DATA PANGGILAN</b></center></h2>
			<i><center>(Data Panggilan Telephone Perusahaan Terkait Kerja Sama Untuk Perusahaan Dan Belah Pihak)</center></i>
            <br><hr>
                ...
                <thead>
                    <tr class="table-dark ">
                        <th class="text-center">ID.Tlp</th>
