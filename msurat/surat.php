...
<body>
  ...
  <div class="fables-header fables-after-overlay">
    <div class="container">
      <h2 class="fables-page-title fables-second-border-color">Data Surat</h2>
    </div>
  </div>
  <!-- /End Header -->
  ...
  <main class="cd__main">
    ...
    <div class="text-center">
            <a href="scetak.php" style="position: absolute;left: 84vh;">
                <button class="btn btn-warning"><i class="fa-solid fa-user-plus"></i>Print Data</button>
            </a>
        </div>
    <div class="text-center">
      <a href="stambah.php" style="position: absolute;">
        ...
        <tbody>
          ...
          ?>
            ...
            <tr class="table-light">
              ...
              <td class="col-2">
                <a href="subah.php?NIP=<?= $row["NIP"]; ?>" onclick="return confirm ('YAKIN MERUBAH DATA ?')"><i class="fa-solid fa-user-pen"></i></a> |
                <a href="shapus.php?NIP=<?= $row["NIP"]; ?>" onclick="return confirm ('YAKIN MENGHAPUS DATA ?')"><i class="fa-solid fa-trash"></i></a>
              </td>
            </tr>
